...
$(document).ready(function() {
    ...
    function drawChartWaterfall() {
        ...
        var optionsWaterfall = {
            ...
            candlestick: {
                fallingColor: { strokeWidth: 0, fill: '#f0466b' }, // red
                risingColor: { strokeWidth: 0, fill: '#33db9e' } // green
            }
        };
    ...
    function drawVisualization() {
        ...
        var options = {
            ...
            seriesType: 'bars',
            series: { 5: { type: 'line' } },
            colors: ['#4fc3f7', '#33db9e', '#f0466b', '#FE8A7D', '#00bcd4', '#536dfe']
        };
    ...
    function drawChartDonut() {
        ...
        var optionsDonut = {
            ...
            pieHole: 0.4,
            colors: ['#4fc3f7', '#33db9e', '#00bcd4', '#FE8A7D', '#f0466b']
        };
    ...
    function drawChartExploading() {
        ...
        var optionsExploading = {
            ...
            colors: ['#4fc3f7', '#33db9e', '#00bcd4', '#FE8A7D', '#69CEC6', '#f0466b']
        };
    ...
    function drawChartThreshold() {
        ...
        var optionsThreshold = {
            ...
            colors: ['#4fc3f7', '#33db9e', '#f0466b', '#ffe100']
        };
