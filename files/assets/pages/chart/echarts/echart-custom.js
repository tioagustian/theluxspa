...
function dashboardEcharts() { /*line chart*/
    ...
    var option = {
        ...
        color: ["rgba(79, 195, 247, 0.95)", "rgba(79, 195, 247, 0.39)", "rgba(79, 195, 247, 0.54)"],
        yAxis: [{
            type: 'value',
            splitLine: {
                show: false
    ...
    var option_dt = {
        ...
        options: [{
                color: ['#4fc3f7', '#f0466b', '#33db9e', '#ff8a65', '#69CEC6', '#536dfe'],
                title: {
                    text: '',
                    subtext: ''
                },
    ...
    option = {
        ...
        series: [{
                ...
                itemStyle: {
                    normal: {
                        color: 'rgba(255, 138, 101, 0.54)',
                        barBorderColor: 'rgba(255, 138, 101, 0.54)',
                        barBorderWidth: 3,
                        barBorderRadius: 0,
                        label: {
                            show: true,
