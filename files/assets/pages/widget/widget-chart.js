...
$(document).ready(function() {
    ...
    var chart = AmCharts.makeChart("lead-overview-chart", {
        type: "serial",
        marginTop: 10,
        hideCredits: true,
        marginRight: 0,
    ...
    var charts = AmCharts.makeChart("sales-analytics-chart", {
        "type": "serial",
        "theme": "light",
        "marginTop": 0,
        "marginRight": 0,
    ...
    // data-use-chart start
    var chartbc = AmCharts.makeChart("coin-price", {
        "type": "serial",
        "theme": "light",
        "dataDateFormat": "YYYY-MM-DD",
        "valueAxes": [{
        ...
        "graphs": [{
            ...
            "lowField": "low",
            "fillAlphas": 0.9,
            "negativeFillColors": "#f0466b",
            "negativeLineColor": "#f0466b",
            "openField": "open",
            "title": "Price:",
            "type": "candlestick",
            "valueField": "close"
    ...
    setTimeout(function() {
        chartbc.zoomToIndexes(Math.round(chartbc.dataProvider.length * 0.45), Math.round(chartbc.dataProvider.length * 0.65));
    }, 800);
    // data-use-chart start
    ...
    var chart = AmCharts.makeChart("btc-eth-chart", {
        "type": "serial",
        "theme": "light",
        "marginRight": 0,
        "marginLeft": 40,
    ...
    // sell-btc-chart start
    var chart = new Chartist.Pie('#sell-btc-chart', {
        series: [5, 7]
    }, {
        donut: true,
        donutWidth: 8,
