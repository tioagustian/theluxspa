    ...
    var PcodedMenu = {
                    ...
                    if (mt === "click") {
                        $("#mobile-collapse,#mobile-collapse1").click(function(e) {
                            ...
                            if ($("#pcoded").attr("vertical-nav-type") == "collapsed") {
                                ...
                                $("body").addClass('menucollapse');
                            } else {
                                $("body").removeClass('menucollapse');
                                $(".main-menu").slimScroll({
        ...
        HandleThemeBackground: function() {
            ...
            function setlheadertheme() {
                ...
                var av = settings.ActiveItemBackground;
                if (ev != undefined && ev != "") {
                    $('#' + oid + ' .pcoded-navigation-label').attr("menu-title-theme", ev);
                } else {
                    $('#' + oid + ' .pcoded-navigation-label').attr("menu-title-theme", "theme1");
                }
                if (av != undefined && av != "") {
                    $('#' + oid + ' .profile-notification').attr("active-item-theme", av);
                } else {
                    $('#' + oid + ' .profile-notification').attr("active-item-theme", "theme1");
                }
            };
            ...
            function Handlebrandlogo() {
                var ev = settings.logoBackground;
                if (ev != undefined && ev != "") {
                    $('#' + oid + ' .navbar-logo').attr("logo-theme", ev);
                } else {
                    $('#' + oid + ' .navbar-logo').attr("logo-theme", "theme1");
                }
            };
        ...
        HandleSubMenuTrigger: function() {
            switch (settings.SubMenuTrigger) {
                ...
                case 'click':
                    ...
                    $(".pcoded-item .pcoded-submenu > li > .pcoded-submenu > li").on('click', function(e) {
                        e.stopPropagation();
                        var str = $(this).closest('.pcoded-submenu').length;
                        if (str === 0) {
                            if ($(this).hasClass('pcoded-trigger')) {
        ...
        HandleMenuOnClick: function() {
            ...
            if (settings.themelayout === "vertical") {
                $('#mobile-collapse,#mobile-collapse1,.sidebar_toggle a, .pcoded-overlay-box,.menu-toggle a').on("click", function() {
        ...
        HandleDeviceType: function() {
            function devicesize() {
                ...
                if (settings.themelayout === "vertical") {
                    ...
                    var tmp_dt = $('#' + oid).attr("vertical-nav-type");
                    if (tmp_dt == "collapsed") {
                        $("body").addClass('menucollapse');
                    } else {
                        $("body").removeClass('menucollapse');
...
$(window).scroll(function() {
    if ($(this).scrollTop() > 50) {
        ...
        $('.pcoded[theme-layout="vertical"] .pcoded-navbar[pcoded-navbar-position="fixed"][pcoded-header-position="relative"] .nav-list').css('height', '100%');
    } else {
...
$(window).on('load', function() {
    ...
    var act = $('.pcoded-item > li.pcoded-trigger');
    setTimeout(function() {
        var elm = $('.pcoded-item .pcoded-trigger.active, .pcoded-item .active');
        var off = elm.offset();
        // var l = off.left;
        var w = elm.width();
        var docH = $(window).height();
