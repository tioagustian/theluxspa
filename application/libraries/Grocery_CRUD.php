...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
	...
	protected function get_integer_input($field_info,$value)
	{
		...
		$input = "<input id='field-{$field_info->name}' name='{$field_info->name}' type='text' value='$value' class='numeric form-control ".$this->customClass."' $extra_attributes />";
		return $input;
	}
	...
	protected function get_string_input($field_info,$value)
	{
		...
		$input = "<input id='field-{$field_info->name}' class='form-control ".$this->customClass."' name='{$field_info->name}' type='text' value=\"$value\" $extra_attributes />";
		return $input;
	}
	...
	protected function get_datetime_input($field_info,$value)
	{
		...
		$input = "<input id='field-{$field_info->name}' name='{$field_info->name}' type='text' value='$datetime' maxlength='19' class='datetime-input form-control ".$this->customClass."' />
	...
	protected function get_hidden_input($field_info,$value)
	{
		...
		$input = "<input id='field-{$field_info->name}' type='hidden' class=' ".$this->customClass."' name='{$field_info->name}' value='$value' />";
		return $input;
	}
	...
	protected function get_password_input($field_info,$value)
	{
		...
		if(!empty($field_info->db_max_length))
			$extra_attributes .= "maxlength='{$field_info->db_max_length}'";
		$input = "<input id='field-{$field_info->name}' class='form-control  ".$this->customClass." name='{$field_info->name}' type='password' value='$value' $extra_attributes />";
		return $input;
	}
	...
	protected function get_date_input($field_info,$value)
	{
		...
		$input = "<input id='field-{$field_info->name}' name='{$field_info->name}' type='text' value='$date' maxlength='10' class='datepicker-input form-control" .$this->customClass." />
	...
	protected function get_upload_file_input($field_info, $value)
	{
		...
		$input = '<span class="fileinput-button qq-upload-button" id="upload-button-'.$unique.'" style="'.$uploader_display_none.'">
			...
			<input type="file" name="'.$this->_unique_field_name($field_info->name).'" class="gc-file-upload '.$this->customClass.'" rel="'.$this->getUploadUrl($field_info->name).'" id="'.$unique.'">
			<input class="hidden-upload-input  '.$this->customClass.'" type="hidden" name="'.$field_info->name.'" value="'.$value.'" rel="'.$this->_unique_field_name($field_info->name).'" />
		</span>';
