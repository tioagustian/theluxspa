...
/* Translated by: M. Yuhdi & Ibrahim Yusuf */
	...
	$lang['list_filtered_from']		= '(disaring dari {total_results} total entri)';
	...
	$lang['minimize_maximize'] = 'Kecilkan/Maksimalkan';
	...
	$lang['list_more'] = 'Lainnya';

	/* Added in version 1.5.6 */
	$lang['list_search_column'] = 'Cari {field_display_as}';

	/* Added in version 1.5.8 */
	$lang['alert_delete_multiple'] = 'Anda yakin akan menghapus {items_amount} item?';

	$lang['alert_delete_multiple_one'] = 'Anda yakin akan menghapus 1 item?';



	/* Added in version 1.6.1 */
	$lang['list_clone'] = 'Gandakan';
