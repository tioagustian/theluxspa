...
?>
<!-- <script type="text/javascript" src="<?= base_url('files/bower_components/datatables.net/js/jquery.dataTables.min.js');?>"></script> -->
<!-- <script type="text/javascript" src="<?= base_url('files/bower_components/datatables.net-buttons/js/dataTables.buttons.min.js');?>"></script>
<script type="text/javascript" src="<?= base_url('files/bower_components/datatables.net-bs4/js/dataTables.bootstrap4.min.js');?>"></script> -->
<!-- <script type="text/javascript" src="<?= base_url('files/bower_components/datatables.net-responsive/js/dataTables.responsive.min.js');?>"></script>
<script type="text/javascript" src="<?= base_url('files/bower_components/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js');?>"></script> -->
...
<div class="grocerycrud-container">
	...
	<div class="dataTablesContainer">
		<?php if(!$unset_add){?>
			...
			<a role="button" class="btn btn-primary waves-effect waves-light" href="<?php echo $add_url?>">
