...
<?php
    ...
    if ($this->config->environment == 'production') {
        ...
        // $this->set_js_lib($this->default_theme_path.'/bootstrap/js/pcoded.min.js');
    } else {
        $this->set_js_lib($this->default_javascript_path.'/'.grocery_CRUD::JQUERY);
        // $this->set_js_lib($this->default_theme_path.'/bootstrap/js/pcoded.min.js');
        	...
        	<div class="table-section">
                ...
                <div class="table-container">
                    <?php echo form_open("", 'method="post" autocomplete="off" id="gcrud-search-form"'); ?>
        			    ...
        			    <table class="table table-bordered table-responsive grocery-crud-table table-hover">
        					<thead>
        						<tr>
        						...
        						<tr class="filter-row gc-search-row">
                                    ...
                                    <?php foreach($columns as $column){?>
                                        <td>
                                            <input type="text" class="form-control searchable-input floatL" placeholder="<?php echo str_replace('{field_display_as}', $column->display_as, $this->l('list_search_column')); ?>" name="<?php echo $column->field_name; ?>" />
                                        </td>
                                    <?php }?>
        						</tr>
